...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption[\textit{In vivo} image of blood vessels.]{\textit{In vivo} image of blood vessel. The animal received \SI{10}{\mg\per\kg} fluorescein-dextran in tail vein. The mini-microscope is placed at cortex when the animal is under anaesthesia. Blood flow speed was calculated using the cross-correlation method described in Section~\ref{meth.bloodvessel}. \subref{fig.sub.bv} Mean fluorescent image of blood vessels under mini-microscope. \subref{fig.sub.vel} Heatmap of eurythrocyte flow speed overlaid on the mean fluorescent image. Eurythrocyte flow speed is measured in \si{\mm\per\second}. \label{f.bloodvessel}}
\end{figure}
