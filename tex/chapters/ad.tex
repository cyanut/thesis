...
Previous reports have suggested that \gls{ca1} neurons in \gls{tg} mice have deficits in encoding spatial information \citep{chang13}. It is possible that such encoding deficit in \gls{ad} is general, and also affects contextual fear memory. We then investigated how \gls{wt} and \gls{tg} cells encodes freezing. 
...
\begin{figure}[h]
    ...
    \caption{The normalized distance to the \gls{gsvm} classification boundary. A positive distance represent \todo{caption}\label{f.ad.cls-distance}}
\end{figure}
