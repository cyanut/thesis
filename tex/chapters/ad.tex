...
\begin{figure}[h]
    \input{../figs/ad/paradigm.pdf_tex}
...
\begin{figure}[h]
    \input{../figs/ad/sample_trace.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/freezing_frequency.pgf}
        \caption{\label{f.ad.freezing_freq}}
    \end{subfigure}
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/freezing_bouts.pgf}
        \caption{\label{f.ad.freezing_bouts}}
    \end{subfigure}
    \caption[Freezing lengths and number of freezing bouts.]{Average number of freezing bouts \subref{f.ad.freezing_freq} and length of freezing bouts \subref{f.ad.freezing_bouts}. \Gls{tg} mice freeze as often as \gls{wt} mice, but with less duration. This is rescued by \tglu{} treatment. \label{f.ad.freezing_profile}}
\end{figure}
...
\begin{figure}[h]
    \begin{subfigure}[h]{0.9\textwidth}
        \input{../figs/ad/activity_train.pgf}
        \caption{\label{f.ad.acttrain}}
    \end{subfigure}
    \begin{subfigure}[h]{0.9\textwidth}
        \input{../figs/ad/activity_test.pgf}
...
\begin{figure}[h]
    \input{../figs/ad/diff_activity.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/activity_freezing.pgf}
        \caption{\label{f.ad.actf}}
    \end{subfigure}
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/activity_moving.pgf}
...
\begin{figure}[h]
    \input{../figs/ad/freeze_position.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[b]{0.5\textwidth}
        \input{../figs/ad/nb.pgf}
        \caption{\label{f.ad.nb}}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \input{../figs/ad/svm.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/nb_into_freezing.pgf}
        \caption{\label{f.ad.nb_into_f}}
    \end{subfigure}
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/svm_into_freezing.pgf}
...
\begin{figure}[h]
    \input{../figs/ad/cls-distance.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/reminder1.pdf_tex}
        \caption{\label{f.ad.reminder1.paradigm}}
    \end{subfigure}
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/reminder1.pgf}
...
\begin{figure}[h]
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/reminder2.pdf_tex}
        \caption{\label{f.ad.reminder2.paradigm}}
    \end{subfigure}
    \begin{subfigure}[h]{\textwidth}
        \input{../figs/ad/reminder2.pgf}
