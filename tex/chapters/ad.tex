...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption[Freezing lengths and number of freezing bouts.]{Average number of freezing bouts \subref{f.ad.freezing_freq} and length of freezing bouts \subref{f.ad.freezing_length_dist, f.ad.freezing_length_bar}. \Gls{tg} mice freeze as often as \gls{wt} mice, but with less duration. This is rescued by \tglu{} treatment. \label{f.ad.freezing_profile}}
\end{figure}
