...
The standard view regards the hippocampus as a tri-synaptic loop \citep{van strien09}. The \gls{ec} collects multimodal sensory information and sends from layer II to \gls{dg} and \gls{ca3} through axons called perforant path. Axons from granular cells in \gls{dg}, called mossy fibers, then synapse onto \gls{ca3}. Pyramidal cells in \gls{ca3} then projects to ipsilateral \gls{ca1} through axons called Schaffer colaterals, and to contralateral \gls{ca1} through commissural pathway. \gls{ca1} pyramidal cells in turn synapses on the deep layer of \gls{ec} either directly or through subiculum \citep{trien09}.
