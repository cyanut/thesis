...
Currently only four drugs are approved for \gls{ad}: three \gls{ache} inhibitors donepezil, rivastigmine and galantamine, and one \gls{nmdar} antagonist memantine \citep{nelson15}.

\Gls{ache} inhibitors aims to chronically increase \gls{ach} concentration in the

Among these, memantine is only available to moderate-severe \gls{ad} patients, used either by itself or combined with \gls{ache} inhibitors.
