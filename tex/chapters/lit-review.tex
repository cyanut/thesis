...
While the stage of \gls{ad} is consistent, the rate of progression is highly variable from patient to patient \citep{komarova11, tschanz11}. 
progression rate

As \gls{ad} is a progressive disorder with no effective treatment, the prognosis for an \gls{ad} patient is not bright. The average survival duration after diagnosis is \SIrange{4}{8}{\year} \citep{larson04, helzner08}. Moreover, \SI{40}{\percent} of the time after diagnosis will be spent with the most severe stage of \gls{ad} \citep{arrighi10}.
